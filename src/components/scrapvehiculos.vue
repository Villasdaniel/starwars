        ...
        <form class="FormUserSup" >
          <div class="pepito">
            ...
            <table class="table table-responsive table-bordered">
              ...
              <paginate name="vehiculos" :list="vehiculos" :per="10" tag="tbody">
                  <tr v-for="vehiculo in paginated('vehiculos')" :key = "vehiculo.data">
                    <td> <a class="nombre" href="../reference/uri-url.html">{{ vehiculo.name }}</a></td>
              ...
              <div id="melocentro">
                <paginate-links for="vehiculos" :limit="5" :show-step-links="true" :classes="{'ul': 'pagination', 'li': 'page-item', 'a': 'page-link'}"></paginate-links>
              </div>
            </table>
          </div>
        </form>
  ...
  export default {
      ...
      mounted() {
        ...
        .then( function (response) {
          ...
          vue.vehiculos = response.data.results
        })
      }
  }
</script>
