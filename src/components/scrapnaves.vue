        ...
        <form class="FormUserSup" >
          <div class="pepito">
            ...
            <table class="table table-responsive table-bordered">
              ...
              <paginate name="naves" :list="naves" :per="10" tag="tbody">
                  <tr v-for="nave in paginated('naves')" :key = "nave.data">
                    <td> <a class="nombre" href="../reference/uri-url.html">{{ nave.name }}</a></td>
                    <td> {{ nave.model }} </td>
              ...
              <div id="melocentro">
                <paginate-links for="naves" :limit="5" :show-step-links="true" :classes="{'ul': 'pagination', 'li': 'page-item', 'a': 'page-link'}"></paginate-links>
              </div>
            </table>
          </div>
        </form>
  ...
  export default {
      ...
      mounted() {
        ...
        .then( function (response) {
          ...
          vue.naves = response.data.results
        })
      }
  }
</script>
